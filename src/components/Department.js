...
export class Department extends Component {
  ...
  FilterFn() {
    var DepartmentIdFiler = this.state.DepartmentIdFiler;
    ...
    var filteredData = this.state.departmentsWithoutFilter.filter(function (
      ...
      return (
        el.DepartmentId.toString()
          .toLowerCase()
          .includes(DepartmentIdFiler.toString().trim().toLowerCase()) &&
  ...
  changeDepartmentIdFilter = (e) => {
    this.state.DepartmentIdFiler = e.target.value;
    this.FilterFn();
  };
  ...
  createClick(dep) {
    fetch(variables.API_URL + "department", {
      ...
      .then(
        ...
        (error) => {
          alert("Insert new Employee is Failed");
        }
      );
  }
  ...
  updateClick() {
    fetch(variables.API_URL + "department", {
      ...
      .then(
        ...
        (error) => {
          alert("UPdate Employee is Failed");
        }
      );
  }
    ...
    if (window.confirm("Are you sure to delete this department?")) {
      fetch(variables.API_URL + "department/" + id, {
        ...
        .then(
          ...
          (error) => {
            alert("Delete Department is Failed!");
          }
        );
    }
  }
  ...
  <path fillRule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
              ...
              <input
                  ...
                  placeholder="Filter By DeptName"
                />
